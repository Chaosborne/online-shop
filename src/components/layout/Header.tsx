          ...
          <div className={styles['app-header__inner']}>
            ...
            <nav className={styles['app-nav']}>
              <ul className={styles['app-menu']}>
                <li><a className={styles['app-menu__login']} href="#">Войти</a></li>
                <li><a className={styles['app-menu__favourites']} href="#">Избранное</a></li>
                <li><a className={styles['app-menu__cart']} href="#">Корзина</a></li>
              </ul>
            </nav>
          </div>
        </div>
