    ...
    <footer className={s.Footer}>
      <div className="container">
        <div className={s.FooterContent}>
          ...
          {/* Технологии */}
          <div className={`${s.FooterSection} ${s.CollapsibleSection} ${isTechOpen ? s.isOpen : ''}`}>
            <div className={s.CollapsibleHeader}>
              <h4 className={s.FooterSubtitle}>Технологии</h4>
              <button
                type="button"
                aria-expanded={isTechOpen}
                className={s.FooterCollapsibleToggler}
                onClick={() => setIsTechOpen(prev => !prev)}
              />
            </div>
            <div className={s.FooterCollapsibleContent}>
          ...
          {/* Функциональность */}
          <div className={`${s.FooterSection} ${s.CollapsibleSection} ${isFeaturesOpen ? s.isOpen : ''}`}>
            <div className={s.CollapsibleHeader}>
          ...
          {/* Контакты */}
          <div className={`${s.FooterSection} ${s.CollapsibleSection} ${isContactsOpen ? s.isOpen : ''}`}>
            <div className={s.CollapsibleHeader}>
